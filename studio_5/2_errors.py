...
def you_forgot_something():
    ...
    # Your Answer: single equals is assinging something to something, and double equals is checking and outputs true or false.
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("10") # What happens if we try to pass a non-number?
